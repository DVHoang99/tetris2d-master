...
namespace Tetris
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            Init();
            _soundPlayer = new SoundPlayer("Land.wav");
        }
        ...
        private void update(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Collide())
                {
                    ...
                    timer1.Tick -= new EventHandler(update);
                    timer1.Stop();
                    if (MessageBox.Show("Bạn có muốn chơi tiếp không?", "Thông báo", MessageBoxButtons.OKCancel) != System.Windows.Forms.DialogResult.OK)
                    {
                        this.Close();
                    }
                    else
